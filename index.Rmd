...
Optimizing the use of the many tools available is covered in detail: **rmarkdown**, **bookdown** and **blogdown** for drafting, **roxygen2**, **testthat** and **pkgdown** for packages, source control with git and GitHub, continuous integration with GitHub Actions and Codecov.
Examples are presented at each step, and the necessary code is provided.

Chapter \@ref(chap-software) is dedicated to the installation of the necessary tools: R, git and LaTeX.
...
Chapter \@ref(chap-this) introduces the use of continuous integration to automatically produce documents, verify package code and produce package thumbnails. 
