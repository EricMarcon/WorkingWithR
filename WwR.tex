...
##  f1(X)  39.777  42.4000  64.72120  44.5340  49.1170
##  f2(X)  48.087  49.8270  71.72165  50.8275  54.4435
##  f3(X) 279.404 281.8725 307.91800 284.5685 295.9505
##  f4(X) 411.187 413.2745 445.98618 420.4965 437.6325
##       max neval
##  1776.338   100
##  1609.042   100
##  1858.866   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.8395
## 2                lapply(x1, FUN = sqrt) 306.8090
## 3                sapply(x1, FUN = sqrt) 372.3805
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 307.0055
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 295.523
## 2                  Loop(x1)  79.427
\end{verbatim}
...
\begin{verbatim}
##                                             expr   median
## 1                      vapply(x1, FUN = sqrt, 0)  302.961
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 3582.508
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 2970.8615
## 2               runif(1000)   21.3795
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1       SumLoop(diamonds[-(2:4)]) 3.686060
## 2 apply(diamonds[-(2:4)], 2, sum) 8.597196
## 3       colSums(diamonds[-(2:4)]) 2.540472
\end{verbatim}
...
Setting up parallelization has a cost of about \texttt{0.027} seconds here.
...
##  779.97 864.72 966.2535 902.7635 951.946 2663.707   100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{5352} seconds.
...
## ● built target NbPoints [2.013 seconds]
## ▶ start target X
...
\begin{verbatim}
## ▶ start target NbPoints
## ● built target NbPoints [1.914 seconds]
## ▶ start target X
## ● built target X [0.004 seconds]
## ▶ start target d
## ● built target d [0.026 seconds]
## ▶ start target map
## ● built target map [0.038 seconds]
## ▶ end pipeline [3.22 seconds]
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  341  345.0   382.94  355.0  402.0
##   triple.numeric(2)  343  352.0 22435.69  362.5  409.0
##          triple(2L) 1400 1429.5 26979.12 1459.5 1516.5
##      max neval
##      989   100
##  2204299   100
##  2546242   100
