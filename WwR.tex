...
##  f1(X)  39.637  41.8290  59.32813  43.8820  47.2435
##  f2(X)  47.561  49.0990  67.17233  50.9010  54.3945
##  f3(X) 277.570 281.9035 308.21120 287.9455 293.2055
##  f4(X) 410.550 415.0640 443.89723 420.6080 429.6880
##       max neval
##  1447.870   100
##  1393.104   100
##  1865.661   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.7620
## 2                lapply(x1, FUN = sqrt) 303.3425
## 3                sapply(x1, FUN = sqrt) 367.0520
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 296.9705
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 306.682
## 2                  Loop(x1)  83.474
\end{verbatim}
...
\begin{verbatim}
##                                             expr    median
## 1                      vapply(x1, FUN = sqrt, 0)  314.5855
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 3669.3115
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 5064.6030
## 2               runif(1000)   26.2475
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1       SumLoop(diamonds[-(2:4)]) 3.687264
## 2 apply(diamonds[-(2:4)], 2, sum) 8.603998
## 3       colSums(diamonds[-(2:4)]) 2.510213
\end{verbatim}
...
Setting up parallelization has a cost of about \texttt{0.066} seconds here.
...
##  2.098321 2.149325 2.531634 2.220732 2.351522 12.85714
##  neval
##    100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{6859} seconds.
...
## ● built target NbPoints [3.301 seconds]
## ▶ start target X
## ● built target X [0.004 seconds]
## ▶ start target d
## ● built target d [0.023 seconds]
## ▶ start target map
## ● built target map [0.095 seconds]
## ▶ end pipeline [3.587 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ start target NbPoints
## ● built target NbPoints [2.972 seconds]
## ▶ start target X
## ● built target X [0.004 seconds]
## ▶ start target d
## ● built target d [0.024 seconds]
## ▶ start target map
## ● built target map [0.096 seconds]
## ▶ end pipeline [3.335 seconds]
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min     lq     mean median   uq
##  triple.integer(2L)  330  338.5 25993.09    348  391
##   triple.numeric(2)  330  341.0 23316.73    354  382
##          triple(2L) 1379 1415.0  1599.13   1433 1498
##      max neval
##  2562645   100
##  2294041   100
##     8598   100
