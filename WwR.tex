...
##  f1(X)  39.053  41.5790  92.42096  43.1580  49.0290
##  f2(X)  46.661  48.6485  71.93944  50.8760  57.2570
##  f3(X) 278.623 281.7795 322.60853 284.8560 291.5045
##  f4(X) 410.674 413.7655 463.04601 417.4205 431.1570
##       max neval
##  1555.860   100
##  1451.631   100
##  1593.384   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.8840
## 2                lapply(x1, FUN = sqrt) 304.8405
## 3                sapply(x1, FUN = sqrt) 397.2135
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 305.0915
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 285.265
## 2                  Loop(x1)  79.686
\end{verbatim}
...
\begin{verbatim}
##                                             expr    median
## 1                      vapply(x1, FUN = sqrt, 0)  294.7875
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 3743.9490
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 5270.3400
## 2               runif(1000)   23.3335
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1       SumLoop(diamonds[-(2:4)])  4.506335
## 2 apply(diamonds[-(2:4)], 2, sum) 13.244036
## 3       colSums(diamonds[-(2:4)])  2.793115
\end{verbatim}
...
##  1.09564 1.151633 1.260441 1.217417 1.26498 2.897048   100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{6020} seconds.
...
## ● completed target NbPoints [2.035 seconds]
## ▶ dispatched target X
## ● completed target X [0.004 seconds]
## ▶ dispatched target d
## ● completed target d [0.021 seconds]
## ▶ dispatched target map
## ● completed target map [0.028 seconds]
## ▶ completed pipeline [2.301 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ dispatched target NbPoints
## ● completed target NbPoints [2.092 seconds]
## ▶ dispatched target X
## ● completed target X [0.004 seconds]
## ▶ dispatched target d
## ● completed target d [0.023 seconds]
## ▶ dispatched target map
## ● completed target map [0.028 seconds]
## ▶ completed pipeline [2.338 seconds]
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  326  338.0 22751.55  346.5  394.5
##   triple.numeric(2)  325  335.5 25234.87  369.0  414.0
##          triple(2L) 1374 1419.0  1543.21 1439.0 1505.0
##      max neval
##  2238013   100
##  2484848   100
##     6870   100
