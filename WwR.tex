...
##  f1(X)   6.150   7.6465  15.44511  10.6395  13.5505 448.704
##  f2(X)   7.913   9.6965  17.12734  12.8535  15.3135 420.783
##  f3(X) 102.418 108.2605 117.36947 111.0075 115.4970 605.939
##  f4(X) 137.924 144.2585 155.53678 147.2105 151.1260 776.868
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   1.7220
## 2                lapply(x1, FUN = sqrt) 143.5820
## 3                sapply(x1, FUN = sqrt) 177.1405
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 140.7120
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 135.6485
## 2                  loop(x1)  42.9680
\end{verbatim}
...
\begin{verbatim}
##                                             expr   median
## 1                      vapply(x1, FUN = sqrt, 0)  143.869
## 2 for (i in 1:length(x1)) root[i] <- sqrt(x1[i]) 1457.939
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 replicate(1000, runif(1)) 685.233
## 2               runif(1000)   5.945
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1      loop_sum(diamonds[-(2:4)]) 1.581288
## 2 apply(diamonds[-(2:4)], 2, sum) 3.535553
## 3       colSums(diamonds[-(2:4)]) 1.210648
\end{verbatim}
...
\NormalTok{n\_cores }\OtherTok{\textless{}{-}} \FunctionTok{detectCores}\NormalTok{() }\SpecialCharTok{{-}} \DecValTok{1}
...
##  280.317 303.974 547.7231 331.2595 552.762 14216.3   100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{2429} seconds.
...
## ✔ skipped pipeline [0.062 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ dispatched target n_points
## ● completed target n_points [1.01 seconds, 53 bytes]
## ▶ dispatched target X
## ● completed target X [0.002 seconds, 11.058 kilobytes]
## ▶ dispatched target d
## ● completed target d [0.008 seconds, 55 bytes]
## ▶ dispatched target map
## ● completed target map [0.019 seconds, 187.39 kilobytes]
## ▶ ended pipeline [1.178 seconds]
\end{verbatim}
...
## Unit: nanoseconds
##                expr min  lq     mean median  uq     max
##  triple.integer(2L) 123 123   168.92    164 164     656
##   triple.numeric(2) 123 123 11238.92    164 164 1106344
##          triple(2L) 533 574  8637.88    574 656  800238
##  neval
##    100
##    100
##    100
