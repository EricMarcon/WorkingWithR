...
##  f1(X)   2.132   6.8470  15.25528   8.6715  11.7055
##  f2(X)   4.141   7.8925  15.70751  10.2090  13.3045
##  f3(X)  97.867 103.0125 162.70768 106.4360 115.0870
##  f4(X) 129.888 136.5505 183.04450 139.7075 148.6660
##       max neval
##   446.941   100
##   463.751   100
##  1948.279   100
...
##                                    expr   median
## 1                              sqrt(x1)   1.6195
## 2                lapply(x1, FUN = sqrt) 140.3840
## 3                sapply(x1, FUN = sqrt) 175.9720
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 140.5275
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 132.3685
## 2                  loop(x1)  41.9840
\end{verbatim}
...
\begin{verbatim}
##                                             expr    median
## 1                      vapply(x1, FUN = sqrt, 0)  143.4385
## 2 for (i in 1:length(x1)) root[i] <- sqrt(x1[i]) 1418.8050
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 replicate(1000, runif(1)) 775.966
## 2               runif(1000)   6.519
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1      loop_sum(diamonds[-(2:4)]) 1.946619
## 2 apply(diamonds[-(2:4)], 2, sum) 4.328821
## 3       colSums(diamonds[-(2:4)]) 1.452076
\end{verbatim}
...
Setting up parallelization has a cost of about \texttt{0.067} seconds here.
...
##  282.695 370.4145 569.0427 476.7275 593.0445 4153.628   100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{2167} seconds.
...
\begin{verbatim}
## + n_points dispatched
## ✔ n_points completed [1s, 53 B]
## + X dispatched
## ✔ X completed [8ms, 11.06 kB]
## + d dispatched
## ✔ d completed [6ms, 55 B]
## + map dispatched
## ✔ map completed [14ms, 187.83 kB]
## ✔ ended pipeline [1.3s, 4 completed, 0 skipped]
\end{verbatim}
...
\begin{verbatim}
## ✔ skipped pipeline [43ms, 4 skipped]
\end{verbatim}
...
\begin{verbatim}
## + n_points dispatched
## ✔ n_points completed [845ms, 53 B]
## + X dispatched
## ✔ X completed [1ms, 11.06 kB]
## + d dispatched
## ✔ d completed [5ms, 55 B]
## + map dispatched
## ✔ map completed [14ms, 187.83 kB]
## ✔ ended pipeline [1.1s, 4 completed, 0 skipped]
\end{verbatim}
...
##  triple.integer(2L) 123 123   156.21    164 164     574
##   triple.numeric(2) 123 123 10300.02    164 164 1013315
##          triple(2L) 533 533  8338.58    574 574  775146
##  neval
##    100
##    100
##    100
