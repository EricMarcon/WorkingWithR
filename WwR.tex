...
##  f1(X)  27.976  30.2275  44.16243  32.6145  37.4580
##  f2(X)  39.242  41.8115  55.28689  44.3715  49.3575
##  f3(X) 238.455 253.8875 275.33632 267.2320 277.1625
##  f4(X) 302.462 319.6510 347.65302 336.7770 346.6835
##       max neval
##  1047.982   100
##   930.295   100
##  1202.300   100
...
##                                    expr   median
## 1                              sqrt(x1)   7.2930
## 2                lapply(x1, FUN = sqrt) 270.8070
## 3                sapply(x1, FUN = sqrt) 313.6045
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 281.2280
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 279.9575
## 2                  Loop(x1)  70.5505
\end{verbatim}
...
\begin{verbatim}
##                                             expr    median
## 1                      vapply(x1, FUN = sqrt, 0)  286.4135
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 2455.4505
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 2153.714
## 2               runif(1000)   15.125
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1       SumLoop(diamonds[-(2:4)]) 2.847066
## 2 apply(diamonds[-(2:4)], 2, sum) 7.115465
## 3       colSums(diamonds[-(2:4)]) 2.009607
\end{verbatim}
...
Setting up parallelization has a cost of about \texttt{0.095} seconds here.
...
##  388.702 795.734 820.7004 803.54 810.268 3142.275   100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{3709} seconds.
...
## ● completed target NbPoints [1.574 seconds]
## ▶ dispatched target X
## ● completed target X [0.004 seconds]
## ▶ dispatched target d
## ● completed target d [0.135 seconds]
## ▶ dispatched target map
## ● completed target map [0.102 seconds]
## ▶ completed pipeline [2.087 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ dispatched target NbPoints
## ● completed target NbPoints [1.543 seconds]
## ▶ dispatched target X
## ● completed target X [0.004 seconds]
## ▶ dispatched target d
## ● completed target d [0.061 seconds]
## ▶ dispatched target map
## ● completed target map [0.028 seconds]
## ▶ completed pipeline [1.793 seconds]
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min   lq     mean median     uq
##  triple.integer(2L)  286  294 15847.72    298  306.0
##   triple.numeric(2)  285  301 17414.61    314  321.0
##          triple(2L) 1053 1066  1149.10   1075 1130.5
##      max neval
##  1554234   100
##  1709670   100
##     4697   100
