...
##  f1(X)  39.178  43.3005  62.03809  45.176  50.8015 1482.545
##  f2(X)  47.559  50.6765  67.41890  52.143  56.0510 1356.813
##  f3(X) 261.993 276.5950 293.77390 278.018 283.9420 1691.917
##  f4(X) 382.434 404.5735 425.02858 406.507 412.8815 1939.176
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   4.4855
## 2                lapply(x1, FUN = sqrt) 295.5535
## 3                sapply(x1, FUN = sqrt) 353.2680
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 289.7890
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 286.8970
## 2                  Loop(x1)  75.7225
\end{verbatim}
...
\begin{verbatim}
##                                             expr   median
## 1                      vapply(x1, FUN = sqrt, 0)  287.744
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 3167.538
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4291.8725
## 2               runif(1000)   35.3175
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1       SumLoop(diamonds[-(2:4)]) 3.751062
## 2 apply(diamonds[-(2:4)], 2, sum) 9.734878
## 3       colSums(diamonds[-(2:4)]) 2.529156
\end{verbatim}
...
##  761.019 769.158 834.1409 780.0465 793.9045 2435.253   100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{4944} seconds.
...
##  triple.integer(2L)  320  330.5 22347.18    338  347.5
##   triple.numeric(2)  318  328.5 19692.12    341  365.5
##          triple(2L) 1264 1283.5  1418.60   1303 1379.5
##      max neval
##  2199652   100
##  1933012   100
##     6316   100
