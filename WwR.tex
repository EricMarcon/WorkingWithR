...
##  f1(X)  42.783  44.3385   86.99268  45.9645  50.1310
##  f2(X)  50.141  51.8190   89.03741  53.1670  58.9775
##  f3(X) 281.503 284.6805  941.92540 290.3180 308.3890
##  f4(X) 413.406 415.8140 1169.44067 421.3990 432.3870
##        max neval
##   1892.257   100
##   1378.285   100
##  54412.118   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.7730
## 2                lapply(x1, FUN = sqrt) 308.7585
## 3                sapply(x1, FUN = sqrt) 367.1150
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 301.1835
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 291.7115
## 2                  Loop(x1)  77.4435
\end{verbatim}
...
\begin{verbatim}
##                                             expr    median
## 1                      vapply(x1, FUN = sqrt, 0)  302.2045
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 3386.9045
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 2913.025
## 2               runif(1000)   33.377
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1       SumLoop(diamonds[-(2:4)])  3.893414
## 2 apply(diamonds[-(2:4)], 2, sum) 10.011225
## 3       colSums(diamonds[-(2:4)])  2.670033
\end{verbatim}
...
Setting up parallelization has a cost of about \texttt{0.022} seconds here.
...
##  2.072108 2.223408 4.010418 2.674975 3.696415 61.37174
##  neval
##    100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{5145} seconds.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  328  331.5 25215.19  341.0  354.5
##   triple.numeric(2)  325  340.0 20396.21  345.0  360.5
##          triple(2L) 1320 1347.0  1487.70 1365.5 1424.5
##      max neval
##  2486584   100
##  2003337   100
##     6507   100
