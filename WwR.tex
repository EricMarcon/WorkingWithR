...
##  f1(X)  39.759  42.9515  72.28769  43.8125  47.2095
##  f2(X)  44.902  50.5390  95.54571  51.7105  55.0205
##  f3(X) 280.585 282.8620 310.05076 286.3210 292.0735
##  f4(X) 412.253 416.3735 478.90132 420.2225 429.9450
##       max neval
##  1545.905   100
##  2957.386   100
##  1691.157   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.7225
## 2                lapply(x1, FUN = sqrt) 315.0420
## 3                sapply(x1, FUN = sqrt) 380.7335
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 306.3325
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 310.2145
## 2                  Loop(x1)  84.2430
\end{verbatim}
...
\begin{verbatim}
##                                             expr   median
## 1                      vapply(x1, FUN = sqrt, 0)  314.388
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 3597.315
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4769.2650
## 2               runif(1000)   22.4095
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1       SumLoop(diamonds[-(2:4)])  4.135924
## 2 apply(diamonds[-(2:4)], 2, sum) 11.244359
## 3       colSums(diamonds[-(2:4)])  2.748669
\end{verbatim}
...
Setting up parallelization has a cost of about \texttt{0.042} seconds here.
...
##  2.15063 2.355033 3.983781 2.791887 4.052103 60.15099   100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{5197} seconds.
...
## ● built target NbPoints [3.388 seconds]
## ▶ start target X
## ● built target X [0.004 seconds]
## ▶ start target d
## ● built target d [0.025 seconds]
## ▶ start target map
## ● built target map [0.029 seconds]
## ▶ end pipeline [3.627 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ start target NbPoints
## ● built target NbPoints [2.614 seconds]
## ▶ start target X
## ● built target X [0.004 seconds]
## ▶ start target d
## ● built target d [0.031 seconds]
## ▶ start target map
## ● built target map [0.029 seconds]
## ▶ end pipeline [2.96 seconds]
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min   lq     mean median     uq
##  triple.integer(2L)  339  344 26370.08  356.5  411.5
##   triple.numeric(2)  330  348 27080.77  380.0  442.0
##          triple(2L) 1399 1449  2599.75 1493.0 1597.5
##      max neval
##  2597675   100
##  2666408   100
##    30148   100
