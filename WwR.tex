...
##  f1(X)  27.765  28.5650  39.05543  29.2015  30.1695
##  f2(X)  38.443  39.6250  49.42537  40.3715  41.3805
##  f3(X) 242.197 246.3135 257.00565 247.1050 248.6185
##  f4(X) 314.089 315.1570 330.87604 315.9645 317.7655
##       max neval
##   895.842   100
##   871.335   100
##  1099.524   100
...
##                                    expr   median
## 1                              sqrt(x1)   7.1690
## 2                lapply(x1, FUN = sqrt) 267.4475
## 3                sapply(x1, FUN = sqrt) 308.8660
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 278.7850
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 279.748
## 2                  Loop(x1)  70.552
\end{verbatim}
...
\begin{verbatim}
##                                             expr   median
## 1                      vapply(x1, FUN = sqrt, 0)  285.989
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 2353.008
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 2504.4620
## 2               runif(1000)   14.9245
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1       SumLoop(diamonds[-(2:4)]) 2.840992
## 2 apply(diamonds[-(2:4)], 2, sum) 7.069250
## 3       colSums(diamonds[-(2:4)]) 2.010451
\end{verbatim}
...
Setting up parallelization has a cost of about \texttt{0.062} seconds here.
...
##  631.49 788.6005 815.6201 795.481 802.905 1715.578   100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{3695} seconds.
...
## ● completed target NbPoints [1.389 seconds]
## ▶ dispatched target X
## ● completed target X [0.003 seconds]
## ▶ dispatched target d
## ● completed target d [0.017 seconds]
## ▶ dispatched target map
## ● completed target map [0.032 seconds]
## ▶ ended pipeline [1.613 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ dispatched target NbPoints
## ● completed target NbPoints [1.381 seconds]
## ▶ dispatched target X
## ● completed target X [0.003 seconds]
## ▶ dispatched target d
## ● completed target d [0.02 seconds]
## ▶ dispatched target map
## ● completed target map [0.036 seconds]
## ▶ ended pipeline [1.609 seconds]
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  292  305.0 14892.88    310  317.0
##   triple.numeric(2)  291  302.5 17350.54    314  326.0
##          triple(2L) 1065 1080.5  1158.35   1089 1132.5
##      max neval
##  1457646   100
##  1703335   100
##     5055   100
