...
##  f1(X)   1.968   2.5420   9.96587   3.1570   8.5280 441.775
##  f2(X)   4.387   4.9610  12.78790   5.6785   9.7170 560.347
##  f3(X)  99.835 107.5020 124.04468 110.2695 115.0870 632.179
##  f4(X) 135.587 141.7985 169.64037 145.3040 152.4995 862.845
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   1.4760
## 2                lapply(x1, FUN = sqrt) 131.7535
## 3                sapply(x1, FUN = sqrt) 159.4695
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 130.9335
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 130.8515
## 2                  loop(x1)  41.6355
\end{verbatim}
...
\begin{verbatim}
##                                             expr    median
## 1                      vapply(x1, FUN = sqrt, 0)  137.0015
## 2 for (i in 1:length(x1)) root[i] <- sqrt(x1[i]) 1088.5705
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 replicate(1000, runif(1)) 754.605
## 2               runif(1000)   6.478
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1      loop_sum(diamonds[-(2:4)]) 1624.297
## 2 apply(diamonds[-(2:4)], 2, sum) 3627.680
## 3       colSums(diamonds[-(2:4)]) 1251.320
\end{verbatim}
...
##  216.111 243.5195 442.9111 290.5055 313.527 11971.47   100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{2372} seconds.
...
## ● completed target n_points [1.018 seconds, 53 bytes]
## ▶ dispatched target X
## ● completed target X [0.004 seconds, 11.058 kilobytes]
## ▶ dispatched target d
## ● completed target d [0.021 seconds, 55 bytes]
## ▶ dispatched target map
## ● completed target map [0.015 seconds, 187.39 kilobytes]
## ▶ ended pipeline [1.186 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ dispatched target n_points
## ● completed target n_points [0.957 seconds, 53 bytes]
## ▶ dispatched target X
...
##  triple.integer(2L) 123  410.0   546.94    451  451.0
##   triple.numeric(2) 123  410.0 11550.11    451  471.5
##          triple(2L) 533 1496.5 26340.04   1517 1599.0
##      max neval
##    13038   100
##  1109091   100
##  2342535   100
