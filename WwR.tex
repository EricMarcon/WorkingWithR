...
##  f1(X)   1.599   2.8905   8.8929   5.945   6.1910 349.894
##  f2(X)   3.854   4.0180  10.4632   7.544   8.0155 342.596
##  f3(X)  92.660  96.4320 104.7874  97.949 100.6345 445.998
##  f4(X) 124.189 127.6125 139.0015 130.052 133.6190 577.198
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   1.3940
## 2                lapply(x1, FUN = sqrt) 128.9860
## 3                sapply(x1, FUN = sqrt) 154.3445
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 128.0020
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 132.471
## 2                  Loop(x1)  41.656
\end{verbatim}
...
\begin{verbatim}
##                                             expr    median
## 1                      vapply(x1, FUN = sqrt, 0)  133.4345
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 1074.6100
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 655.6925
## 2               runif(1000)   5.8630
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1       SumLoop(diamonds[-(2:4)]) 1494.040
## 2 apply(diamonds[-(2:4)], 2, sum) 3334.038
## 3       colSums(diamonds[-(2:4)]) 1166.225
\end{verbatim}
...
##  219.432 221.728 265.5279 230.051 237.2055 3217.024   100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{1984} seconds.
...
## ● completed target NbPoints [0.66 seconds, 53 bytes]
## ▶ dispatched target X
...
\begin{verbatim}
## ▶ dispatched target NbPoints
## ● completed target NbPoints [0.594 seconds, 53 bytes]
## ▶ dispatched target X
## ● completed target X [0.001 seconds, 11.058 kilobytes]
## ▶ dispatched target d
...
##  triple.integer(2L) 123 123 6558.36    123 123 642470   100
##   triple.numeric(2)  82 123 8367.28    123 123 823854   100
##          triple(2L) 492 492  563.34    533 533   2706   100
\end{verbatim}
