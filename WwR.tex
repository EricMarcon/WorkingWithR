...
##  f1(X)  38.539  40.7530  55.36177  42.4170  44.6250
##  f2(X)  45.721  48.4155  64.06855  50.5225  54.2215
##  f3(X) 259.419 272.6800 289.52365 276.8995 283.4980
##  f4(X) 380.716 395.1940 419.36291 405.2145 413.5280
##       max neval
##  1218.427   100
##  1194.194   100
##  1445.611   100
...
##                                    expr  median
## 1                              sqrt(x1)   4.444
## 2                lapply(x1, FUN = sqrt) 295.058
## 3                sapply(x1, FUN = sqrt) 350.593
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 289.487
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 283.506
## 2                  Loop(x1)  74.035
\end{verbatim}
...
\begin{verbatim}
##                                             expr   median
## 1                      vapply(x1, FUN = sqrt, 0)  286.748
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 3180.662
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4589.261
## 2               runif(1000)   33.243
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1       SumLoop(diamonds[-(2:4)]) 3.747954
## 2 apply(diamonds[-(2:4)], 2, sum) 9.549501
## 3       colSums(diamonds[-(2:4)]) 2.515625
\end{verbatim}
...
##  759.57 769.4685 900.646 783.088 805.414 2361.851   100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{4457} seconds.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  317  330.0 29740.81    340  350.0
##   triple.numeric(2)  316  329.5 20170.41    340  371.5
##          triple(2L) 1287 1315.5  1456.89   1360 1413.0
##      max neval
##  2939207   100
##  1981073   100
##     6381   100
