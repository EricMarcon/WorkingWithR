...
##  f1(X)  44.175  46.9815  73.91042  49.366  58.9680 1740.904
##  f2(X)  51.062  55.1250  80.66677  58.075  66.6595 1622.330
##  f3(X) 283.064 292.8340 331.55791 305.078 333.4865 1905.150
##  f4(X) 416.043 430.9090 477.06004 445.465 478.6415 2362.989
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   4.9120
## 2                lapply(x1, FUN = sqrt) 322.0415
## 3                sapply(x1, FUN = sqrt) 396.6490
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 313.6365
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 298.087
## 2                  Loop(x1)  84.511
\end{verbatim}
...
\begin{verbatim}
##                                             expr   median
## 1                      vapply(x1, FUN = sqrt, 0)  311.665
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 3752.084
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 5094.928
## 2               runif(1000)   23.015
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1       SumLoop(diamonds[-(2:4)])  5.098197
## 2 apply(diamonds[-(2:4)], 2, sum) 12.926538
## 3       colSums(diamonds[-(2:4)])  3.228102
\end{verbatim}
...
Setting up parallelization has a cost of about \texttt{0.1} seconds here.
...
##  2.078613 2.130388 2.73433 2.160607 2.214471 45.38716   100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{6049} seconds.
...
## ● built target NbPoints [2.182 seconds]
## ▶ start target X
## ● built target X [0.004 seconds]
## ▶ start target d
## ● built target d [0.023 seconds]
## ▶ start target map
## ● built target map [0.031 seconds]
## ▶ end pipeline [2.43 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ start target NbPoints
## ● built target NbPoints [1.994 seconds]
## ▶ start target X
## ● built target X [0.004 seconds]
## ▶ start target d
## ● built target d [0.023 seconds]
## ▶ start target map
## ● built target map [0.027 seconds]
## ▶ end pipeline [2.226 seconds]
\end{verbatim}
...
##  triple.integer(2L)  332  341.5 25272.69  350.0  380.5
##   triple.numeric(2)  331  344.5 21511.09  362.5  397.5
##          triple(2L) 1380 1420.5  1602.40 1445.0 1552.5
##      max neval
##  2490066   100
##  2113108   100
##     7643   100
