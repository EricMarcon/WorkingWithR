...
##  f1(X)  43.497  46.3015  64.74435  48.2975  52.8785
##  f2(X)  51.880  54.4910  73.95323  55.9725  59.4115
##  f3(X) 285.635 288.9140 312.06387 290.4525 301.2260
##  f4(X) 416.628 420.0535 444.41160 422.9570 432.3195
##       max neval
##  1404.406   100
##  1504.520   100
##  1871.913   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6500
## 2                lapply(x1, FUN = sqrt) 302.2960
## 3                sapply(x1, FUN = sqrt) 359.9225
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 295.7905
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 293.4275
## 2                  Loop(x1)  77.6800
\end{verbatim}
...
\begin{verbatim}
##                                             expr    median
## 1                      vapply(x1, FUN = sqrt, 0)  298.6285
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 3422.6190
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 3755.8875
## 2               runif(1000)   36.2145
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1       SumLoop(diamonds[-(2:4)])  4.100018
## 2 apply(diamonds[-(2:4)], 2, sum) 11.116013
## 3       colSums(diamonds[-(2:4)])  2.901244
\end{verbatim}
...
##  2.159869 2.265267 4.012652 2.41905 4.518602 33.83954   100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{7772} seconds.
...
To create the workflow shown in section `\textcite{ref}(sec:targets), the code is simply:
...
##  triple.integer(2L)  315  326 24471.85    335  353 2411945
##   triple.numeric(2)  312  324 21746.06    333  348 2139598
##          triple(2L) 1276 1310  1450.42   1336 1399    6431
##  neval
##    100
##    100
##    100
