...
##  f1(X)  39.885  41.8590  62.82048  44.5600  48.4080
##  f2(X)  47.756  49.7745  73.64126  54.0095  62.3590
##  f3(X) 277.979 281.8335 316.45531 289.6875 308.4715
##  f4(X) 410.369 417.8090 464.38448 439.3810 468.6680
##       max neval
##  1600.947   100
##  1518.761   100
##  1736.349   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6965
## 2                lapply(x1, FUN = sqrt) 315.0505
## 3                sapply(x1, FUN = sqrt) 373.5520
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 297.3395
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 305.3740
## 2                  Loop(x1)  82.7195
\end{verbatim}
...
\begin{verbatim}
##                                             expr   median
## 1                      vapply(x1, FUN = sqrt, 0)  294.623
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 3431.556
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4186.6335
## 2               runif(1000)   23.7365
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1       SumLoop(diamonds[-(2:4)]) 3.839558
## 2 apply(diamonds[-(2:4)], 2, sum) 8.724299
## 3       colSums(diamonds[-(2:4)]) 2.585617
\end{verbatim}
...
##  2.098634 2.183573 2.997544 2.233729 2.894297 20.42916
##  neval
##    100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{8347} seconds.
...
## ● built target NbPoints [2.245 seconds]
## ▶ start target X
## ● built target X [0.003 seconds]
## ▶ start target d
## ● built target d [0.027 seconds]
## ▶ start target map
## ● built target map [0.172 seconds]
## ▶ end pipeline [2.684 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ start target NbPoints
## ● built target NbPoints [1.869 seconds]
## ▶ start target X
## ● built target X [0.003 seconds]
## ▶ start target d
## ● built target d [0.023 seconds]
## ▶ start target map
## ● built target map [0.094 seconds]
## ▶ end pipeline [2.151 seconds]
\end{verbatim}
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  327  338.0 25316.52  347.0  409.5
##   triple.numeric(2)  330  340.0 23155.65  346.5  409.0
##          triple(2L) 1399 1429.5  1613.42 1459.0 1532.5
##      max neval
##  2494207   100
##  2276877   100
##     7804   100
