...
##  f1(X)  38.614  41.9185  65.82405  43.3205  46.4880
##  f2(X)  45.509  49.2475  87.88802  51.5315  55.2540
##  f3(X) 277.965 283.5705 467.16179 288.6140 342.6775
##  f4(X) 410.988 415.9175 819.37149 429.1095 464.0250
##        max neval
##   1434.440   100
##   2856.748   100
##  10288.576   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.5890
## 2                lapply(x1, FUN = sqrt) 304.5190
## 3                sapply(x1, FUN = sqrt) 363.7765
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 298.4595
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 292.8535
## 2                  Loop(x1)  77.5910
\end{verbatim}
...
\begin{verbatim}
##                                             expr   median
## 1                      vapply(x1, FUN = sqrt, 0)  298.404
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 3439.684
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 3886.6230
## 2               runif(1000)   33.5455
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1       SumLoop(diamonds[-(2:4)]) 3.746722
## 2 apply(diamonds[-(2:4)], 2, sum) 9.658807
## 3       colSums(diamonds[-(2:4)]) 2.536055
\end{verbatim}
...
Setting up parallelization has a cost of about \texttt{0.021} seconds here.
...
##  1.103037 1.47426 1.985825 2.077056 2.097725 12.37315   100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{6582} seconds.
...
The files in \texttt{content/authors/admin/} must be duplicated into \texttt{content/en/authors/admin/} and \texttt{content/fr/...}.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  325  339.5 86099.08    368  421.5
##   triple.numeric(2)  325  337.5 41399.78    363  410.0
##          triple(2L) 1360 1404.0  1652.44   1483 1548.5
##      max neval
##  8537393   100
##  4100759   100
##     9414   100
