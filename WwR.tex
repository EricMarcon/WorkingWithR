...
\tightlist
\item
  \texttt{sum()} function belongs to the basic language of R and is a builtin function;
\item
...
##  f1(X)  39.536  42.0655  62.68352  44.3815  46.5935
##  f2(X)  48.087  49.6010  68.98649  51.3490  54.4110
##  f3(X) 281.114 283.2460 314.49766 289.4885 301.0705
##  f4(X) 412.416 414.6440 445.37852 421.3340 433.9670
##       max neval
##  1432.936   100
##  1289.131   100
##  1554.419   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.6055
## 2                lapply(x1, FUN = sqrt) 304.1965
## 3                sapply(x1, FUN = sqrt) 360.7220
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 296.3380
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 294.1310
## 2                  Loop(x1)  77.4405
\end{verbatim}
...
\begin{verbatim}
##                                             expr   median
## 1                      vapply(x1, FUN = sqrt, 0)  298.245
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 3361.976
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4349.722
## 2               runif(1000)   33.457
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1       SumLoop(diamonds[-(2:4)]) 3.732976
## 2 apply(diamonds[-(2:4)], 2, sum) 9.809735
## 3       colSums(diamonds[-(2:4)]) 2.541031
\end{verbatim}
...
Setting up parallelization has a cost of about \texttt{0.031} seconds here.
...
##  2.067794 2.113499 2.62759 2.129802 2.407034 9.58047   100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{5217} seconds.
...
Each commit is accompanied by a description text.
...
\tightlist
\item
  the working directory, or sandbox, which contains files that are not considered: unknown, modified, deleted or renamed (\enquote{Staged} box unchecked);
\item
...
To work with several people on the same project, the project owner must give access to the project to collaborators (fig:git-Access), i.e.~other GitHub users in the repository settings.
...
The document contains Markdown formatted text and code chunks surrounded by three grave accents (the Markdown syntax of a code block) and a language description, here \texttt{r}.
...
\multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 0.75in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{Sepal\ Length}}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 0.75in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{Width}}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 0.75in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{Petal\ Length}}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedleft}p{\dimexpr 0.75in+0\tabcolsep+0\arrayrulewidth}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{Width}}}} & \multicolumn{1}{!{\color[HTML]{000000}\vrule width 0pt}>{\raggedright}p{\dimexpr 0.75in+0\tabcolsep+0\arrayrulewidth}!{\color[HTML]{000000}\vrule width 0pt}}{\fontsize{11}{11}\selectfont{\textcolor[HTML]{000000}{\global\setmainfont{Helvetica}{Species}}}} \\
...
The \texttt{content/authors/admin/\_index.md} file which contains information about the owner of the site is replaced by \texttt{content/en/authors/admin/\_index.md} (respectively \texttt{.../fr/...}).
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  324  338.5 25118.35  348.5  401.5
##   triple.numeric(2)  324  338.0 20427.28  351.0  397.5
##          triple(2L) 1343 1403.0  1648.11 1443.0 1510.0
##      max neval
##  2474545   100
##  2005210   100
##     9397   100
...
Enter the name of the classroom: a good practice is to prefix it with the name of the course and add the name of the session, for example \enquote{Course-R-2020}.
