...
##  f1(X)  39.119  41.4565  59.06774  42.946  47.4920 1369.352
##  f2(X)  46.529  49.0625  70.63597  50.843  57.3905 1508.485
##  f3(X) 286.107 288.6375 320.80732 293.101 303.6545 2001.046
##  f4(X) 426.714 429.5990 462.88632 433.617 445.8955 2028.743
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   4.8260
## 2                lapply(x1, FUN = sqrt) 305.1035
## 3                sapply(x1, FUN = sqrt) 368.9625
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 296.5915
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 287.109
## 2                  Loop(x1)  82.996
\end{verbatim}
...
\begin{verbatim}
##                                             expr   median
## 1                      vapply(x1, FUN = sqrt, 0)  292.822
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 3389.760
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 4664.172
## 2               runif(1000)   25.423
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1       SumLoop(diamonds[-(2:4)]) 3.621117
## 2 apply(diamonds[-(2:4)], 2, sum) 8.381659
## 3       colSums(diamonds[-(2:4)]) 2.474616
\end{verbatim}
...
##  2.074912 2.150425 2.201235 2.188925 2.213095 3.973874
##  neval
##    100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{7659} seconds.
...
## ● built target NbPoints [3.325 seconds]
## ▶ start target X
## ● built target X [0.004 seconds]
## ▶ start target d
## ● built target d [0.024 seconds]
## ▶ start target map
## ● built target map [0.033 seconds]
## ▶ end pipeline [3.67 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ start target NbPoints
## ● built target NbPoints [3.461 seconds]
## ▶ start target X
## ● built target X [0.004 seconds]
## ▶ start target d
## ● built target d [0.023 seconds]
## ▶ start target map
## ● built target map [0.03 seconds]
## ▶ end pipeline [3.685 seconds]
\end{verbatim}
...
##  triple.integer(2L)  328  337.0 138119.70  350.5  392.0
##   triple.numeric(2)  329  342.0  47416.91  354.0  384.5
##          triple(2L) 1416 1458.5   1637.99 1482.5 1533.0
##       max neval
##  13775193   100
##   4704156   100
##      7973   100
