...
##  f1(X)  40.498  43.7405  60.83275  44.9575  51.1625
##  f2(X)  47.950  51.5280  66.80816  53.1410  56.5110
##  f3(X) 272.686 287.4470 305.24955 290.2555 296.3885
##  f4(X) 402.111 424.5930 455.39531 426.9465 436.5670
##       max neval
##  1299.675   100
##  1225.901   100
##  1458.541   100
...
##                                    expr   median
## 1                              sqrt(x1)   4.7370
## 2                lapply(x1, FUN = sqrt) 308.3935
## 3                sapply(x1, FUN = sqrt) 369.5295
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 300.8005
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 313.6495
## 2                  Loop(x1)  81.0440
\end{verbatim}
...
\begin{verbatim}
##                                             expr   median
## 1                      vapply(x1, FUN = sqrt, 0)  315.319
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 4716.267
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 5077.943
## 2               runif(1000)   35.753
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1       SumLoop(diamonds[-(2:4)])  4.074272
## 2 apply(diamonds[-(2:4)], 2, sum) 11.195222
## 3       colSums(diamonds[-(2:4)])  2.723461
\end{verbatim}
...
Setting up parallelization has a cost of about \texttt{0.15} seconds here.
...
##  2.098584 2.114137 2.271895 2.130346 2.168113 12.41155
##  neval
##    100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{7459} seconds.
...
## Unit: nanoseconds
##                expr  min     lq     mean median   uq
##  triple.integer(2L)  327  335.5 24106.17  344.5  392
##   triple.numeric(2)  323  335.5 24724.36  344.5  372
##          triple(2L) 1331 1365.5  1764.12 1421.5 1527
##      max neval
##  2373198   100
##  2434985   100
##    21316   100
