...
##  f1(X)  29.170  34.6410 163.0828  48.577  99.8135 2182.523
##  f2(X)  39.896  46.6325 171.1654  65.267 115.5050 2800.638
##  f3(X) 247.519 277.4585 533.0039 312.870 428.9305 9809.609
##  f4(X) 315.446 372.7715 546.5919 418.736 568.8665 2572.013
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   7.9170
## 2                lapply(x1, FUN = sqrt) 356.5975
## 3                sapply(x1, FUN = sqrt) 432.6330
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 363.1410
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 315.8630
## 2                  Loop(x1)  76.5645
\end{verbatim}
...
\begin{verbatim}
##                                             expr   median
## 1                      vapply(x1, FUN = sqrt, 0)  341.254
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 3308.588
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 4104.9100
## 2               runif(1000)   17.8125
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1       SumLoop(diamonds[-(2:4)])  6.370532
## 2 apply(diamonds[-(2:4)], 2, sum) 23.995221
## 3       colSums(diamonds[-(2:4)])  5.272117
\end{verbatim}
...
##  798.229 883.988 951.0134 906.33 918.3265 4353.922   100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{4245} seconds.
...
## ● completed target NbPoints [1.406 seconds]
## ▶ dispatched target X
## ● completed target X [0.003 seconds]
## ▶ dispatched target d
## ● completed target d [0.018 seconds]
## ▶ dispatched target map
## ● completed target map [0.025 seconds]
## ▶ completed pipeline [1.602 seconds]
\end{verbatim}
...
\begin{verbatim}
## ▶ dispatched target NbPoints
## ● completed target NbPoints [1.412 seconds]
## ▶ dispatched target X
## ● completed target X [0.004 seconds]
## ▶ dispatched target d
## ● completed target d [0.014 seconds]
## ▶ dispatched target map
## ● completed target map [0.024 seconds]
## ▶ completed pipeline [1.615 seconds]
\end{verbatim}
...
##  triple.integer(2L)  306  317.5 23125.84  327.5  441.0
##   triple.numeric(2)  302  323.5 29021.64  333.5  391.5
##          triple(2L) 1100 1118.0  1973.14 1146.0 1332.5
##      max neval
##  2238027   100
##  2826625   100
##    43495   100
