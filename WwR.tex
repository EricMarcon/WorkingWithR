...
##  f1(X)   1.804   2.8700  10.87115   6.6625   8.5485 444.809
##  f2(X)   4.141   5.0225  12.72271   8.7535  10.9060 437.388
##  f3(X) 101.229 106.4360 119.30590 109.5520 115.4970 654.852
##  f4(X) 134.316 141.5730 157.70896 145.6525 150.9415 834.063
##  neval
##    100
##    100
##    100
...
##                                    expr   median
## 1                              sqrt(x1)   1.5580
## 2                lapply(x1, FUN = sqrt) 139.8305
## 3                sapply(x1, FUN = sqrt) 168.3050
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 138.8670
\end{verbatim}
...
\begin{verbatim}
##                        expr  median
## 1 vapply(x1, FUN = sqrt, 0) 132.266
## 2                  Loop(x1)  43.173
\end{verbatim}
...
\begin{verbatim}
##                                             expr    median
## 1                      vapply(x1, FUN = sqrt, 0)  132.4915
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 1043.3065
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 659.5055
## 2               runif(1000)   5.6990
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1       SumLoop(diamonds[-(2:4)]) 1545.700
## 2 apply(diamonds[-(2:4)], 2, sum) 3364.501
## 3       colSums(diamonds[-(2:4)]) 1177.582
\end{verbatim}
...
Setting up parallelization has a cost of about \texttt{0.17} seconds here.
...
##  219.842 225.2335 290.7285 232.429 238.415 4431.362   100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{2437} seconds.
...
## ● completed target NbPoints [0.795 seconds]
## ▶ dispatched target X
...
##  triple.integer(2L) 123 123 7452.16    123 164 729800   100
##   triple.numeric(2) 123 123 9742.01    164 164 959154   100
##          triple(2L) 533 574  745.79    574 615  10373   100
\end{verbatim}
