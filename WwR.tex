...
##  f1(X)   1.886   7.0725  13.85308   8.2410  12.5255
##  f2(X)   4.264   9.3890  17.77104  10.7830  14.4115
##  f3(X) 102.172 107.6045 136.27621 110.0440 114.0005
##  f4(X) 133.906 140.9785 182.57710 145.2425 151.1260
##       max neval
##   452.189   100
##   625.619   100
##  1840.695   100
...
##                                    expr  median
## 1                              sqrt(x1)   1.763
## 2                lapply(x1, FUN = sqrt) 149.773
## 3                sapply(x1, FUN = sqrt) 182.327
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 145.673
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 130.7285
## 2                  Loop(x1)  40.3850
\end{verbatim}
...
\begin{verbatim}
##                                             expr    median
## 1                      vapply(x1, FUN = sqrt, 0)  146.2265
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 1255.4815
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 replicate(1000, runif(1)) 752.5755
## 2               runif(1000)   6.1910
\end{verbatim}
...
\begin{verbatim}
##                              expr   median
## 1       SumLoop(diamonds[-(2:4)]) 1.669807
## 2 apply(diamonds[-(2:4)], 2, sum) 3.970522
## 3       colSums(diamonds[-(2:4)]) 1.369257
\end{verbatim}
...
##  253.011 298.767 358.4056 304.179 312.256 4914.752   100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{2204} seconds.
...
## ● completed target NbPoints [0.83 seconds]
## ▶ dispatched target X
...
\begin{verbatim}
## ▶ dispatched target NbPoints
## ● completed target NbPoints [0.685 seconds]
## ▶ dispatched target X
## ● completed target X [0.001 seconds]
## ▶ dispatched target d
## ● completed target d [0.006 seconds]
## ▶ dispatched target map
## ● completed target map [0.012 seconds]
## ▶ ended pipeline [0.798 seconds]
\end{verbatim}
...
##  triple.integer(2L) 123 123  7789.59  164.0 164  728119
##   triple.numeric(2) 123 123 10348.81  164.0 164 1018317
##          triple(2L) 533 574   649.44  594.5 615    4797
##  neval
##    100
##    100
##    100
