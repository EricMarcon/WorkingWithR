...
##  f1(X)  42.060  44.5370  60.07555  46.0215  48.6905
##  f2(X)  49.789  51.6920  66.50137  53.2325  55.4085
##  f3(X) 277.065 285.1565 303.13320 286.9435 293.6190
##  f4(X) 404.063 416.7340 435.36476 418.6035 423.9330
##       max neval
##  1280.016   100
##  1258.865   100
##  1494.735   100
...
##                                    expr  median
## 1                              sqrt(x1)   4.716
## 2                lapply(x1, FUN = sqrt) 305.342
## 3                sapply(x1, FUN = sqrt) 363.609
## 4 vapply(x1, FUN = sqrt, FUN.VALUE = 0) 298.068
\end{verbatim}
...
\begin{verbatim}
##                        expr   median
## 1 vapply(x1, FUN = sqrt, 0) 295.4780
## 2                  Loop(x1)  77.5785
\end{verbatim}
...
\begin{verbatim}
##                                             expr    median
## 1                      vapply(x1, FUN = sqrt, 0)  296.4725
## 2 for (i in 1:length(x1)) Root[i] <- sqrt(x1[i]) 3327.1320
\end{verbatim}
...
\begin{verbatim}
##                        expr    median
## 1 replicate(1000, runif(1)) 3094.0965
## 2               runif(1000)   33.0005
\end{verbatim}
...
\begin{verbatim}
##                              expr    median
## 1       SumLoop(diamonds[-(2:4)])  4.527635
## 2 apply(diamonds[-(2:4)], 2, sum) 19.267824
## 3       colSums(diamonds[-(2:4)])  2.773020
\end{verbatim}
...
Setting up parallelization has a cost of about \texttt{0.044} seconds here.
...
##  2.051554 2.100243 2.464222 2.129571 2.183781 10.38892
##  neval
##    100
\end{verbatim}
...
This time is to be compared to that of the reference for loop, multiplied by 2500, that is \texttt{5497} seconds.
...
## Unit: nanoseconds
##                expr  min     lq     mean median     uq
##  triple.integer(2L)  317  330.0 24617.70    339  387.5
##   triple.numeric(2)  316  331.0 40527.22    345  389.0
##          triple(2L) 1274 1311.5  1480.08   1351 1410.5
##      max neval
##  2426187   100
##  4015728   100
##     6752   100
