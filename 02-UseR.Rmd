...
This is the simplest method but it does not work under Windows (it is a limitation of the operating system).
...
For everyday use, `mclapply` is faster, except under Windows, and simpler (including on Windows thanks to the above workaround).
