...
kableExtra::kbl(
  my_iris, 
  caption = "Table created by kable", 
  booktabs = TRUE, 
  escape = FALSE
) %>%
...
```{r}
#| label: rediger-GitHub-Clone
#| echo: false
#| fig.cap: "(ref:rediger-GitHub-Clone)"
...
```{r}
#| label: rediger-Projet-GitHub
#| echo: false
#| fig.cap: "(ref:rediger-Projet-GitHub)"
...
```{r}
#| label: rediger-skills
#| echo: false
#| fig.cap: "(ref:rediger-skills)"
...
```{r}
#| label: rediger-experience
#| echo: false
#| fig.cap: "(ref:rediger-experience)"
...
- `n_points`:
```{targets n_points, tar_simple=TRUE, tar_interactive=FALSE}
  1000
```
